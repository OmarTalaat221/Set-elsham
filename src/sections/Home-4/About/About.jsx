...
const About = () => {
  ...
  return (
    typeof window !== undefined && (
      <div
        className="about-area-4 space overflow-hidden"
        ref={counterRef}
        id="about-sec"
      >
            ...
            <div className="col-xl-6">
              <div className="about-thumb4 mb-40 mb-xl-0">
                ...
                <div className="client-group-4-1 jump">
                  <img
                    src="/main-assets/img/normal/client_group_4-1.png"
                    alt="img"
                  />
                </div>
                <div className="about-counter-wrap">
                  ...
                  <p className="about-counter-text">
              ...
              <div className="about-wrap4">
                <div className="title-area mb-40">
                  <span className="sub-title text-theme">
                    ABOUT US <i className="ri-arrow-right-down-line"></i>
                  </span>
                  <h2 className="sec-title">
                    We building everything that you needed
                  </h2>
                  <p className="sec-text">
                    Welcome to Construz. We are architecture with a rich history
                    of excellence, we have been empowering industries and
                    driving progress for over 36 years.
                  </p>
                </div>
                <div className="about-tab-4">
                  ...
                  <div className={`filter-active-${activeTab} filter-content`}>
                    <div
                      className={`filter-item cat1 ${activeTab === "cat1" ? "active" : "display-none"}`}
                    >
                    ...
                    <div
                      className={`filter-item cat2 ${activeTab === "cat2" ? "active" : "display-none"}`}
                    >
                      <p className="about-tab-text">
                        In the tranquil moments of reflection, when the mind is
                        unburdened by the demands of the day, we find a profound
                        sense of clarity. These instances, where our thoughts
                        flow freely and our choices are unfettered by external
                      </p>
                    </div>
                    <div
                      className={`filter-item cat3 ${activeTab === "cat3" ? "active" : "display-none"}`}
                    >
                      <p className="about-tab-text">
                        When the weight of responsibilities is momentarily
                        lifted, and we stand at the crossroads of our own
                        desires, there lies the true essence of freedom. In
                        these rare, unencumbered hours, where we are guided
                        solely by our
                      </p>
                    </div>
                  </div>
                ...
                <div className="btn-group mt-50">
                  <Link href="/about" className="btn">
                    NOW MORE COMPANY <i className="ri-arrow-right-up-line"></i>
                  </Link>
                  <img
                    src="/main-assets/img/normal/about_4-sign.png"
                    alt="img"
                  />
                </div>
              </div>
