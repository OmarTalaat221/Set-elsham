    ...
    <div>
      <div className="hero-wrapper home-five-hero hero-4" id="hero">
        ...
        >
          <div id="slide1">
            <div
              className={`hero-slide background-image ${currentSlide == 0 ? "slick-current slick-active" : ""}`}
              data-opacity="4"
              data-overlay="title"
              style={{
                backgroundImage: "url('/main-assets/img/hero/hero_bg_4_1.png')",
              }}
            >
          ...
          <div id="slide2">
            <div
              className={`hero-slide background-image ${currentSlide == 1 ? "slick-current slick-active" : ""}`}
              data-opacity="4"
              data-overlay="title"
              style={{
                backgroundImage: "url('/main-assets/img/hero/hero_bg_4_2.png')",
              }}
            >
              <div className="container">
                <div className="hero-style4">
          ...
          <div id="slide3">
            <div
              className={`hero-slide background-image ${currentSlide == 2 ? "slick-current slick-active" : ""}`}
              data-opacity="4"
              data-overlay="title"
              style={{
                backgroundImage: "url('/main-assets/img/hero/hero_bg_4_3.png')",
              }}
            >
              <div className="container">
                <div className="hero-style4">
      ...
      <div className="hero-contact-area position-relative z-index-common">
        ...
        <div className="container">
          <div className="hero-contact-wrap">
            <div
              className="hero-award-wrap"
              style={{
                backgroundImage:
                  "url('/main-assets/img/hero/hero_4_award_bg.png')",
              }}
            >
              <div className="hero-award-icon">
                <img
                  src="/main-assets/img/hero/hero_4_award_icon.svg"
                  alt="img"
                />
              </div>
            ...
            <div className="hero-contact-info-wrap">
              <div className="hero-contact-icon">
                <img
                  src="/main-assets/img/hero/hero4-contact-info-icon1.svg"
                  alt="img"
                />
              </div>
            ...
            <div className="hero-contact-info-wrap">
              <div className="hero-contact-icon">
                <img
                  src="/main-assets/img/hero/hero4-contact-info-icon2.svg"
                  alt="img"
                />
              </div>
            ...
            <div className="hero-contact-info-wrap">
              <div className="hero-contact-icon">
                <img
                  src="/main-assets/img/hero/hero4-contact-info-icon3.svg"
                  alt="img"
                />
              </div>
