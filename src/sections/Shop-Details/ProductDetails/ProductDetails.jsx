    ...
    <>
        ...
        <div className="container">
          <div className="row gx-60">
            <div className="col-xl-6">
              <div className="product-big-img">
                <div className="img">
                  <img
                    src="/main-assets/img/product/product_details_1_1.jpg"
                    alt="Product Image"
                  />
                </div>
              </div>
            ...
            <div className="col-xl-6 align-self-center">
              <div className="product-about">
                ...
                <div className="checklist">
                  <ul>
                    <li>
                      <i className="ri-checkbox-circle-line"></i> Lifetime
                      structural, one year finish warranty
                    </li>
                    <li>
                      <i className="ri-checkbox-circle-line"></i> Mapped from
                      “Center Caps” under ” tment” tab
                    </li>
                    <li>
                      <i className="ri-checkbox-circle-line"></i> Fully
                      copatible with OEM equimpent
                    </li>
                  </ul>
                </div>
                ...
                <div className="product_meta">
                  ...
                  <span className="posted_in">
                    Category:{" "}
                    <Link href="/pages/innerpage/shop" rel="tag">
                      Tires & Wheels
                    </Link>
                  </span>
                  <span>
                    Tags:{" "}
                    <Link href="/pages/innerpage/shop">automotive parts</Link>
                    <Link href="/pages/innerpage/shop">wheels</Link>
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="product-tab-area">
            ...
            <div className="tab-content" role="tabpanel">
              ...
              >
                <p>
                  Credibly negotiate emerging materials whereas
                  clicks-and-mortar intellectual capital. Compellingly
                  whiteboard client-centric sources before cross-platform
                  schemas. Distinctively develop future-proof outsourcing
                  without multimedia based portals. Progressively coordinate
                  next-generation architectures for collaborative solutions.
                  Professionally restore backward-compatible quality vectors
                  before customer directed metrics. Holisticly restore
                  technically sound internal or "organic" sources before
                  client-centered human capital underwhelm holistic mindshare
              ...
              >
                <div className="comments-wrap">
                      ...
                      <div className="post-comment">
                        ...
                        <div className="comment-content">
                          ...
                          <p className="text">
                            ...
                            corrupti quos dolores at vero eos accusamus iusto
                            odio dignissimos. Saepe corporis beatae a eaque non?
                            Repudiandae veritatis recusandae perspiciatis, sint
                            maxime dolor quam doloribus!
                          </p>
                        ...
                        <li className="comment-item">
                          <div className="post-comment">
                            ...
                            <div className="comment-content">
                              ...
                              <p className="text">
                                Accusamus iusto odio dignissimos ducimus
                                blanditiis praesentium voluptatum deleniti atque
                                corrupti quos dolores simos temporibus at
                                similique vitae placeat veritatis nobis dolore.
                                Cumque sint molestias repudiandae quaerat
                                eligendi?
                              </p>
                              <div className="reply_and_edit">
                                <Link
                      ...
                      <div className="post-comment">
                        ...
                        <div className="comment-content">
                          ...
                          <p className="text">
                            ...
                            productivate plug-and-play markets whereas
                  ...
                  <h3 className="blog-inner-title mt-n2 mb-15">
                    Leave a Reply
                  </h3>
                  <p>
            ...
            >
              <div className="col-lg-3 col-md-6">
                <div className="product-card product-card-extra-style-space">
                  <div className="product-img">
                    <img
                      src="/main-assets/img/product/product_1_1.jpg"
                      alt="Product Image"
                    />
                    <div className="actions">
                      <button
                        onClick={handleOpenMagnificPopup}
              ...
              <div className="col-lg-3 col-md-6">
                <div className="product-card product-card-extra-style-space">
                  <div className="product-img">
                    <img
                      src="/main-assets/img/product/product_1_2.jpg"
                      alt="Product Image"
                    />
                    <div className="actions">
                      <button
              ...
              <div className="col-lg-3 col-md-6">
                <div className="product-card product-card-extra-style-space">
                  <div className="product-img">
                    <img
                      src="/main-assets/img/product/product_1_3.jpg"
                      alt="Product Image"
                    />
                    <div className="actions">
                      <button
              ...
              <div className="col-lg-3 col-md-6">
                <div className="product-card product-card-extra-style-space">
                  <div className="product-img">
                    <img
                      src="/main-assets/img/product/product_1_4.jpg"
                      alt="Product Image"
                    />
                    <div className="actions">
                      <button
              ...
              <div className="col-lg-3 col-md-6">
                <div className="product-card product-card-extra-style-space">
                  <div className="product-img">
                    <img
                      src="/main-assets/img/product/product_1_5.jpg"
                      alt="Product Image"
                    />
                    <div className="actions">
                      <button
      ...
      <Modal open={isOpen} onClose={handleClosePopup}>
        <div className="mfp-content space-top-none-card">
          <div
            id="QuickView"
            className={`white-popup ${isOpen ? "" : "mfp-hide"}`}
          >
              ...
              <div className="row gx-60">
                ...
                <div className="col-lg-6 align-self-center">
                  <div className="product-about">
                    ...
                    <p className="text">
                      Syndicate customized growth strategies prospective human
                      capital leverage others optimal e-markets without
                      transparent catalysts for change. Credibly coordinate
                      highly efficient methods of empowerment cross unit
                      solutions.
                    </p>
                    <div className="checklist">
                      <ul>
                        ...
                        <li>
                          <i className="ri-checkbox-circle-line"></i> Mapped
                          from “Center Caps” under ” tment” tab
                        </li>
                        <li>
                          <i className="ri-checkbox-circle-line"></i> Fully
                          copatible with OEM equimpent
                    ...
                    <div className="product_meta">
                      ...
                      <span>
                        Tags:{" "}
                        <Link href="/pages/innerpage/shop">
                          automotive parts
                        </Link>
                        <Link href="/pages/innerpage/shop">wheels</Link>
                      </span>
