const FooterThree = () => {
  return (
    <footer className="footer-wrapper footer-layout2 bg-title shape-mockup-wrap">
      <div
        className="footer_shape_2-1 shape-mockup"
              ...
              <div className="widget widget_nav_menu footer-widget">
                ...
                <div className="menu-all-pages-container grid-style">
                  <ul className="menu">
                    ...
                    <li>
                      <a href="/pages/innerpage/service">What We Do</a>
                    </li>
                    <li>
                      <a href="/pages/innerpage/service">News & Article</a>
                    </li>
                    <li>
                      <a href="/pages/innerpage/service">Success Story</a>
                    </li>
                    <li>
                      <a href="/pages/innerpage/service">FAQ’s</a>
                    </li>
                  </ul>
                  <ul className="menu">
                    <li>
                      <a href="/pages/innerpage/team">Our Team</a>
                    </li>
                    <li>
                      <a href="/pages/innerpage/service">Careers</a>
                    </li>
                    <li>
          ...
          <div className="row gy-3 justify-content-center">
            <div className="col-auto align-self-center">
              <p className="copyright-text text-center">
                © 2024 <a href="#">Construz</a> | All rights reserved
              </p>
            </div>
          </div>
        </div>
