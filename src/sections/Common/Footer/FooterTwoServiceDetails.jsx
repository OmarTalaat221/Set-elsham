          ...
          <div className="subscribe-box">
            ...
            <form className="newsletter-form">
              <input
                ...
                required
              />
              <button type="submit" className="btn btn-footer-two style2">
              ...
              <div className="widget widget_nav_menu footer-widget">
                ...
                <div className="menu-all-pages-container grid-style">
                  <ul className="menu">
                    ...
                    <li>
                      <Link href="/pages/innerpage/news">News & Article</Link>
                    </li>
                    <li>
                      <Link href="/pages/innerpage/success">Success Story</Link>
                    </li>
                    <li>
                  ...
                  <ul className="menu">
                    ...
                    <li>
                      <Link href="/pages/innerpage/careers">Careers</Link>
                    </li>
                    <li>
                      <Link href="/pages/innerpage/testimonials">
                        Testimonials
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link href="/pages/innerpage/terms">Terms of use</Link>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="col-md-6 col-xl-auto">
              <div className="widget footer-widget widget-contact">
                ...
                <p className="contact-text">
                  Los Angeles, Street Road 24, New York, USA - 67452
                </p>
