    ...
    <footer className="w-full bg-[#F7F5F1] pt-12 font-[Cairo]" dir="rtl">
      ...
      <div className="hidden lg:block max-w-[1200px] mx-auto px-6 pb-12">
        <div className="grid grid-cols-3 gap-6 mb-8">
              ...
              <div className="space-y-2">
                {servicesRight.map((service) => (
                  <a
                    key={service}
                    href="#"
                    className="block w-fit text-sm !text-[#023048] transition-all duration-200 hover:text-[#C9A24A] hover:translate-x-1"
                  >
                    {service}
                  </a>
                ))}
          ...
          {/* Column 4 - Brand & Contact (Far Left in RTL) */}
          <div className="col-span-1">
            {/* Brand Logo */}
          ...
          <div>
            ...
            <div className="flex flex-col gap-4 ">
              <a href="tel:6005xxxx" className="flex items-center gap-3 group">
                {/* <div className="w-8 h-8 rounded-full bg-[#023048] flex items-center justify-center group-hover:bg-[#C9A24A] transition-colors">
                  <svg width="16" height="16" viewBox="0 0 24 24" className="fill-white">
                    <path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z" />
                  </svg>
                </div> */}
                <span className="text-sm !text-[#023048] group-hover:text-[#C9A24A] transition-colors">600 5xxxx</span>
              </a>
      ...
      {/* Tablet Layout */}
      <div className="hidden md:block lg:hidden max-w-[900px] mx-auto px-6 pb-12">
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 ">
                <div className="space-y-2">
                  {servicesRight.map((service) => (
                    <a key={service} href="#" className="block text-sm !text-[#023048] hover:text-[#C9A24A]">
                      {service}
                    </a>
                  ))}
                </div>
            ...
            {/* Important Links */}
            <div>
              <h4 className="text-base font-bold !text-[#023048] mb-1 pb-2  inline-block">
                روابط مهمة
              </h4>
              <div className="grid grid-cols-2 gap-2 ">
                <div className="space-y-2">
                  {importantLinksRight.map((link, index) => (
                    <a
                      key={link}
                      href="#"
                      className={`block text-sm ${index === 0 ? 'text-[#C9A24A] font-semibold' : '!text-[#023048] hover:text-[#C9A24A]'
                        }`}
                    >
                      {link}
                    </a>
                ...
                <div className="space-y-2">
                  {importantLinksLeft.map((link) => (
                    <a key={link} href="#" className="block text-sm !text-[#023048] hover:text-[#C9A24A]">
                      {link}
                    </a>
                  ))}
                </div>
            ...
            <div>
              ...
              <div className=" space-y-1">
                <p className="text-sm !text-[#023048]">الأحد - الخميس</p>
                <p className="text-sm !text-[#023048] font-medium">8:00 AM - 4:00 PM</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-col gap-3 ">
                <a href="tel:6005xxxx" className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-[#023048] flex items-center justify-center">
                    <svg width="16" height="16" viewBox="0 0 24 24" className="fill-white">
                      <path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z" />
                    </svg>
                  </div>
                  <span className="text-sm !text-[#023048]">600 5xxxx</span>
                </a>
                <a href="mailto:custservice@setalsham.com" className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-[#023048] flex items-center justify-center">
                    <svg width="16" height="16" viewBox="0 0 24 24" className="fill-white">
                      <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" />
                    </svg>
                  </div>
                  <span className="text-xs !text-[#023048]">custservice@setalsham.com</span>
                </a>
                <a href="#" className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-green-600 font-medium">راسلنا واتساب</span>
                </a>
              </div>
            </div>
          </div>
      ...
      <div className="md:hidden px-5 pb-8">
        ...
        {[
          ...
          { id: 'important', title: 'روابط مهمة', content: [...importantLinksRight, ...importantLinksLeft] },
          { id: 'hours', title: 'ساعات العمل', content: ['الأحد - الخميس', '8:00 AM - 4:00 PM', 'متاحين على مدار العام'], isText: true },
        ].map((section) => (
          <div key={section.id} className="border-b border-[#e0d8cc]">
            <button
              className="flex justify-between items-center w-full py-4"
              onClick={() => toggleSection(section.id)}
            >
              <h4 className="text-base font-semibold !text-[#023048]">
                {section.title}
              </h4>
              <svg
                className={`w-4 h-4 !text-[#023048] transition-transform duration-300 ${expandedSection === section.id ? 'rotate-180' : ''
                  }`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            ...
            <div
              className={`overflow-hidden transition-all duration-300 ease-in-out ${expandedSection === section.id ? 'max-h-96 pb-4' : 'max-h-0'
                }`}
            >
              <div className="grid grid-cols-2 gap-2">
                {section.content.map((item, index) => (
                  section.isText ? (
                    <p
                      key={item}
                      className={`col-span-2 text-sm ${index === section.content.length - 1 ? 'text-[#6B7C8D]' : '!text-[#023048]'
                        }`}
                    >
                      {item}
                    </p>
                    ...
                    <a
                      key={item}
                      href="#"
                      className={`text-sm transition-colors ${section.id === 'important' && index === 0
                        ? 'text-[#C9A24A] font-semibold'
                        : '!text-[#023048] hover:text-[#C9A24A]'
                        }`}
                    >
                      {item}
        ...
        {/* App Download - Mobile */}
        <div className="py-6 border-b border-[#e0d8cc]">
          <h4 className="text-base font-semibold !text-[#023048] ">
            حمل تطبيقنا
          </h4>
        ...
        <div className="pt-6">
          ...
          <div className="space-y-3">
            <a href="tel:6005xxxx" className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-[#023048] flex items-center justify-center">
            ...
            <a href="mailto:custservice@setalsham.com" className="flex items-center gap-3">
              ...
              <span className="text-sm !text-[#023048]">custservice@setalsham.com</span>
            </a>
            <a href="#" className="flex items-center gap-3">
