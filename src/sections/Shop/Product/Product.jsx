              ...
              <div className="row gy-40">
                ...
                <div className="col-xl-4 col-md-6 product-space-none">
                  <div className="product-card">
                    <div className="product-img">
                      <img
                        src="/main-assets/img/product/product_1_6.jpg"
                        alt="Product Image"
                      />
                      <div className="actions">
                        <button
                ...
                <div className="col-xl-4 col-md-6 product-space-none">
                  <div className="product-card">
                    <div className="product-img">
                      <img
                        src="/main-assets/img/product/product_1_7.jpg"
                        alt="Product Image"
                      />
                      <div className="actions">
                        <button
                ...
                <div className="col-xl-4 col-md-6 product-space-none">
                  <div className="product-card">
                    <div className="product-img">
                      <img
                        src="/main-assets/img/product/product_1_8.jpg"
                        alt="Product Image"
                      />
                      <div className="actions">
                        <button
                ...
                <div className="col-xl-4 col-md-6 product-space-none">
                  <div className="product-card">
                    <div className="product-img">
                      <img
                        src="/main-assets/img/product/product_1_9.jpg"
                        alt="Product Image"
                      />
                      <div className="actions">
                        <button
                  ...
                  <div className="price_slider_wrapper">
                    <div className="">
                      <Slider
                        ...
                        trackStyle={[{ backgroundColor: "#1f2a50" }]}
                        handleStyle={[
                          { borderColor: "#1f2a50" },
                          { borderColor: "#1f2a50" },
                        ]}
                    ...
                    <div className="price_label">
                      Price: <span className="from">${priceRange[0]}</span> —{" "}
