        ...
        >
          <div className="col-md-6 col-lg-4">
            <div className="blog-card style5">
              <div className="blog-img">
                <img
                  src="/main-assets/img/blog/blog_5_1.png"
                  alt="blog image"
                />
              ...
              <div className="blog-content">
                <div className="blog-meta">
                  <Link href="/blog">By Jr. Saller</Link>
                  <Link href="/blog">News in 2024</Link>
                </div>
          ...
          <div className="col-md-6 col-lg-4">
            <div className="blog-card style5">
              <div className="blog-img">
                <img
                  src="/main-assets/img/blog/blog_5_2.png"
                  alt="blog image"
                />
                <div className="blog-date">
                  <Link href="/blog">
          ...
          <div className="col-md-6 col-lg-4">
            <div className="blog-card style5">
              <div className="blog-img">
                <img
                  src="/main-assets/img/blog/blog_5_3.png"
                  alt="blog image"
                />
                <div className="blog-date">
                  <Link href="/blog">
