            ...
            <div className="about-thumb4 mb-40 mb-xl-0">
              ...
              <div className="about-counter-wrap">
                <h3 className="about-counter-number">
                  <span className="counter-number">2.6</span>k+
                </h3>
            ...
            <div className="about-wrap4">
              <div className="title-area mb-40">
                ...
                <p className="sec-text">
                  ...
                  of excellence, we have been empowering industries and driving
                  progress for over 36 years.
                </p>
              </div>
              ...
              <div className="row">
                ...
                <div className="col-lg-6">
                  <div className="checklist style7">
                    <ul>
                      <li>
                        <i className="ri-checkbox-circle-line"></i> Transforming
                        ideas into reality
                      </li>
                    </ul>
                  </div>
