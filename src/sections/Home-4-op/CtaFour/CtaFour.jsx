    ...
    >
      <div className="cta-area-4 space-top" id="contact-sec">
        <div className="container">
          <div
            className="cta-wrap4 text-center"
            style={{
              backgroundImage: "url('/main-assets/img/bg/cta-bg4-1.png')",
            }}
            data-overlay="title"
            data-opacity="6"
          >
          ...
          >
            <div className="col-md-6 col-lg-4">
              <div className="blog-card style4">
                <div className="blog-img">
                  <img
                    src="/main-assets/img/blog/blog_4_1.png"
                    alt="blog image"
                  />
            ...
            <div className="col-md-6 col-lg-4">
              <div className="blog-card style4">
                <div className="blog-img">
                  <img
                    src="/main-assets/img/blog/blog_4_2.png"
                    alt="blog image"
                  />
                  <div className="blog-date">
                    <Link href="/blog">
                ...
                <div className="blog-content">
                  <div className="blog-meta">
                    <Link href="/blog">By Rebecca</Link>
                    <Link href="/blog">Office</Link>
                    <Link href="/blog">News 2024</Link>
                  </div>
                  <h3 className="blog-title">
                    <Link href="/blog-details">
            ...
            <div className="col-md-6 col-lg-4">
              <div className="blog-card style4">
                <div className="blog-img">
                  <img
                    src="/main-assets/img/blog/blog_4_3.png"
                    alt="blog image"
                  />
                  <div className="blog-date">
                    <Link href="/blog">
