...
const ProjectFour = () => {
  return (
    <div
      className="bg-shape"
      style={{
        backgroundImage: "url('/main-assets/img/bg/project-bg4-1.png')",
      }}
    >
            ...
            <div className="col-lg-auto">
              <div className="sec-btn">
                <div className="icon-box">
                  <button
                    data-slick-prev=".portfolio-slider4"
                    className="slick-arrow default style2"
                  >
                    <i className="ri-arrow-left-line"></i>
                  </button>
                  <button
                    data-slick-next=".portfolio-slider4"
                    className="slick-arrow default style2"
                  >
            ...
            >
              <div className="col-lg-4">
                <div className="portfolio-card style4">
                  <div className="portfolio-card-thumb">
                    <img
                      src="/main-assets/img/project/project4_1.png"
                      alt="img"
                    />
                  ...
                  <div className="portfolio-card-details">
                    ...
                    <h4 className="portfolio-card-title">
                      <Link href="/project-details">News Office Building</Link>
                    </h4>
                  </div>
              ...
              <div className="col-lg-4">
                <div className="portfolio-card style4">
                  <div className="portfolio-card-thumb">
                    <img
                      src="/main-assets/img/project/project4_2.png"
                      alt="img"
                    />
              ...
              <div className="col-lg-4">
                <div className="portfolio-card style4">
                  <div className="portfolio-card-thumb">
                    <img
                      src="/main-assets/img/project/project4_3.png"
                      alt="img"
                    />
