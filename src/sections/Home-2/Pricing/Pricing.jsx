      ...
      <div className="container">
        <div className="row justify-content-xxl-between justify-content-center align-items-center">
          ...
          <div className="col-xxl-5 col-xl-8">
            <p className="sec-text mt-xxl-0 mt-n3 home-two-pricing-align mb-xxl-0 mb-40">
            ...
            <div className="row gy-4 justify-content-center">
              <div className="col-xl-4 col-md-6">
                <div
                  ...
                  style={{
                    backgroundImage:
                      "url('/main-assets/img/bg/pricing-card-bg1-1.png')",
                  }}
                >
                ...
                >
                  ...
                  <div className="pricing-card-details">
                    <div className="pricing-card-icon">
                      <div className="icon">
                        <img
                          src="/main-assets/img/icon/pricing-icon1-1.svg"
                          alt="img"
                        />
                      </div>
