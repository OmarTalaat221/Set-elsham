...
const Portfolio = () => {
  ...
  const images = [
    {
      imgSrc: "/main-assets/img/project/project2_1.png",
      category: "Building",
      title: "Building Construction",
    },
    {
      imgSrc: "/main-assets/img/project/project2_2.png",
      category: "Construction",
      title: "General Construction",
    },
    {
      imgSrc: "/main-assets/img/project/project2_3.png",
      category: "Remodeling",
    ...
    <div className="portfolio-area-2 space" id="project-sec">
      <div className="container">
        ...
        <div className="portfolio-slider2 overflow-hidden">
          <Slider
            {...settings}
            className="row gy-30 gx-30 global-carousel slider-shadow slick-initialized slick-slider"
          >
      ...
      <div className="extra-style">
        {lightboxOpen && (
          <Lightbox
            ...
            prevSrc={
              images[(lightboxIndex + images.length - 1) % images.length].imgSrc
            }
